...
public class TableData extends AbstractTableModel {
    ...
    protected static final String URL = "jdbc:mysql://<REDACTED>:3306/db";
    protected static final String User = "<REDACTED>";
    protected static final String Password = "<REDACTED>";
